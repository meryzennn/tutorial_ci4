		...
		<ul class="nav menu">
			<li class="active"><a href="index"><span class="glyphicon glyphicon-dashboard"></span> Dashboard</a></li>
			...
			<li><a href="login-admin"><span class="glyphicon glyphicon-user"></span> Login Page</a></li>
		</ul>
